...
abstract class Prefs(val name: String, val context: Context) {
    ...
    protected fun getString(key: String, defValue: String = ""): String = preferences.getString(key, defValue).orEmpty()

    protected fun putString(key: String, value: String) = preferences.edit().putString(key, value).apply()

//    protected fun getStringSet(key: String, defValue: MutableSet<String> = mutableSetOf()): MutableSet<String> = preferences.getStringSet(key, defValue).orEmpty()
